document.addEventListener("DOMContentLoaded", comienzoDiferido());

function comienzoDiferido() {
  var temporizador = window.setInterval(anochece, 10000);
}

function anochece() {
  var box = document.querySelector("body");
  box.classList.toggle("anochece");
}
